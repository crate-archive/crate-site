...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DownloadDelta', fields ['file', 'date']
        db.delete_unique('packages_downloaddelta', ['file_id', 'date'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'DownloadDelta', fields ['file', 'date']
        db.create_unique('packages_downloaddelta', ['file_id', 'date'])
