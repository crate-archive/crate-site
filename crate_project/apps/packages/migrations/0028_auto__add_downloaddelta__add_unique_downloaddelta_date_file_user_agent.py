...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'packages.downloaddelta': {
            ...
            'deleta': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
