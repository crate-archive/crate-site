...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'DownloadDelta', fields ['user_agent']
        db.create_index('packages_downloaddelta', ['user_agent'])

    def backwards(self, orm):
        # Removing index on 'DownloadDelta', fields ['user_agent']
        db.delete_index('packages_downloaddelta', ['user_agent'])
