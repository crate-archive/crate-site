...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLLastModified'
        db.create_table('pypi_urllastmodified', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=512)),
            ('last_modified', self.gf('django.db.models.fields.CharField')(max_length=125)),
        ))
        db.send_create_signal('pypi', ['URLLastModified'])

    def backwards(self, orm):
        # Deleting model 'URLLastModified'
        db.delete_table('pypi_urllastmodified')
    ...
    models = {
        ...
        'pypi.urllastmodified': {
            'Meta': {'object_name': 'URLLastModified'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.CharField', [], {'max_length': '125'}),
